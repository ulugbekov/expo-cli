...
async function selectAdhocProvisioningProfile(context, options = {}) {
  // check for existing profiles (list?)

  // options: create, choose existing -> if not associated with dist cert, options to modify
